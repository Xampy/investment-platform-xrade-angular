...
export class SponsorshipProfitService extends AbstractAPIRequest {

    constructor(
        private http: HttpClient
    ) { 
        super(environment.XRADE_API_BASE_URL, "member/fund/sponsorship-profit");
    }

    /**
     * Create de withdral request on the sponsorship profit
     * amount
     * 
     * @param data 
     * @returns 
    ...
    /**
     * Merge interest account and the sponsorship account.
     * 
